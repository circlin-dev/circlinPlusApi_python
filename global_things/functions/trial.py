...
def build_chat_message(user_nickname, manager_nickname):
    ...
    now_0h = (now + timedelta(seconds=20)).strftime("%Y-%m-%d %H:%M:%S")
    now_1h = (now + timedelta(seconds=40)).strftime("%Y-%m-%d %H:%M:%S")

    d1_0802 = (now + timedelta(minutes=1)).strftime("%Y-%m-%d %H:%M:%S")
    d1_1145 = (now + timedelta(minutes=1, seconds=10)).strftime("%Y-%m-%d %H:%M:%S")
    d1_1522 = (now + timedelta(minutes=1, seconds=20)).strftime("%Y-%m-%d %H:%M:%S")
    d1_1820 = (now + timedelta(minutes=1, seconds=30)).strftime("%Y-%m-%d %H:%M:%S")
    d1_2112 = (now + timedelta(minutes=1, seconds=40)).strftime("%Y-%m-%d %H:%M:%S")

    d2_0730 = (now + timedelta(minutes=2, seconds=10)).strftime("%Y-%m-%d %H:%M:%S")
    d2_1005 = (now + timedelta(minutes=2, seconds=20)).strftime("%Y-%m-%d %H:%M:%S")
    d2_1221 = (now + timedelta(minutes=2, seconds=30)).strftime("%Y-%m-%d %H:%M:%S")
    d2_1430 = (now + timedelta(minutes=2, seconds=40)).strftime("%Y-%m-%d %H:%M:%S")
    d2_1603 = (now + timedelta(minutes=2, seconds=50)).strftime("%Y-%m-%d %H:%M:%S")
    d2_1810 = (now + timedelta(minutes=2, seconds=60)).strftime("%Y-%m-%d %H:%M:%S")
    d2_2019 = (now + timedelta(minutes=2, seconds=70)).strftime("%Y-%m-%d %H:%M:%S")
    d2_2200 = (now + timedelta(minutes=2, seconds=80)).strftime("%Y-%m-%d %H:%M:%S")

    d3_0749 = (now + timedelta(minutes=3, seconds=10)).strftime("%Y-%m-%d %H:%M:%S")
    d3_1132 = (now + timedelta(minutes=3, seconds=20)).strftime("%Y-%m-%d %H:%M:%S")
    d3_1552 = (now + timedelta(minutes=3, seconds=30)).strftime("%Y-%m-%d %H:%M:%S")
    d3_1902 = (now + timedelta(minutes=3, seconds=40)).strftime("%Y-%m-%d %H:%M:%S")
    d3_2139 = (now + timedelta(minutes=3, seconds=50)).strftime("%Y-%m-%d %H:%M:%S")

    d4_0850 = (now + timedelta(minutes=4, seconds=10)).strftime("%Y-%m-%d %H:%M:%S")
    d4_1100 = (now + timedelta(minutes=4, seconds=20)).strftime("%Y-%m-%d %H:%M:%S")
    d4_1407 = (now + timedelta(minutes=4, seconds=30)).strftime("%Y-%m-%d %H:%M:%S")
    d4_1830 = (now + timedelta(minutes=4, seconds=40)).strftime("%Y-%m-%d %H:%M:%S")
    d4_2042 = (now + timedelta(minutes=4, seconds=50)).strftime("%Y-%m-%d %H:%M:%S")

    d5_0830 = (now + timedelta(minutes=5, seconds=10)).strftime("%Y-%m-%d %H:%M:%S")
    d5_1121 = (now + timedelta(minutes=5, seconds=20)).strftime("%Y-%m-%d %H:%M:%S")
    d5_1720 = (now + timedelta(minutes=5, seconds=30)).strftime("%Y-%m-%d %H:%M:%S")
    d5_2045 = (now + timedelta(minutes=5, seconds=40)).strftime("%Y-%m-%d %H:%M:%S")

    d6_0841 = (now + timedelta(minutes=6, seconds=10)).strftime("%Y-%m-%d %H:%M:%S")
    d6_1103 = (now + timedelta(minutes=6, seconds=20)).strftime("%Y-%m-%d %H:%M:%S")
    d6_1844 = (now + timedelta(minutes=6, seconds=30)).strftime("%Y-%m-%d %H:%M:%S")
    d6_2209 = (now + timedelta(minutes=6, seconds=40)).strftime("%Y-%m-%d %H:%M:%S")
