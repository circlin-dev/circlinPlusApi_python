...
def build_chat_message(user_nickname, manager_nickname):
    ...
    now_1h = (now + timedelta(minutes=1)).strftime("%Y-%m-%d %H:%M:%S")

    d1_0802 = (now + timedelta(minutes=1)).strftime("%Y-%m-%d 08:02:00")
    d1_1145 = (now + timedelta(minutes=1)).strftime("%Y-%m-%d 11:45:00")
    d1_1522 = (now + timedelta(minutes=1)).strftime("%Y-%m-%d 15:22:00")
    d1_1820 = (now + timedelta(minutes=1)).strftime("%Y-%m-%d 18:20:00")
    d1_2112 = (now + timedelta(minutes=1)).strftime("%Y-%m-%d 21:12:00")

    d2_0730 = (now + timedelta(minutes=2)).strftime("%Y-%m-%d 07:30:00")
    d2_1005 = (now + timedelta(minutes=2)).strftime("%Y-%m-%d 10:05:00")
    d2_1221 = (now + timedelta(minutes=2)).strftime("%Y-%m-%d 12:21:00")
    d2_1430 = (now + timedelta(minutes=2)).strftime("%Y-%m-%d 14:30:00")
    d2_1603 = (now + timedelta(minutes=2)).strftime("%Y-%m-%d 16:03:00")
    d2_1810 = (now + timedelta(minutes=2)).strftime("%Y-%m-%d 18:10:00")
    d2_2019 = (now + timedelta(minutes=2)).strftime("%Y-%m-%d 20:19:00")
    d2_2200 = (now + timedelta(minutes=2)).strftime("%Y-%m-%d 22:00:00")

    d3_0749 = (now + timedelta(minutes=3)).strftime("%Y-%m-%d 07:49:00")
    d3_1132 = (now + timedelta(minutes=3)).strftime("%Y-%m-%d 11:32:00")
    d3_1552 = (now + timedelta(minutes=3)).strftime("%Y-%m-%d 15:52:00")
    d3_1902 = (now + timedelta(minutes=3)).strftime("%Y-%m-%d 19:02:00")
    d3_2139 = (now + timedelta(minutes=3)).strftime("%Y-%m-%d 21:39:00")

    d4_0850 = (now + timedelta(minutes=4)).strftime("%Y-%m-%d 08:50:00")
    d4_1100 = (now + timedelta(minutes=4)).strftime("%Y-%m-%d 11:00:00")
    d4_1407 = (now + timedelta(minutes=4)).strftime("%Y-%m-%d 14:07:00")
    d4_1830 = (now + timedelta(minutes=4)).strftime("%Y-%m-%d 18:30:00")
    d4_2042 = (now + timedelta(minutes=4)).strftime("%Y-%m-%d 20:42:00")

    d5_0830 = (now + timedelta(minutes=5)).strftime("%Y-%m-%d 08:30:00")
    d5_1121 = (now + timedelta(minutes=5)).strftime("%Y-%m-%d 11:21:00")
    d5_1720 = (now + timedelta(minutes=5)).strftime("%Y-%m-%d 17:20:00")
    d5_2045 = (now + timedelta(minutes=5)).strftime("%Y-%m-%d 20:45:00")

    d6_0841 = (now + timedelta(minutes=6)).strftime("%Y-%m-%d 08:41:00")
    d6_1103 = (now + timedelta(minutes=6)).strftime("%Y-%m-%d 11:03:00")
    d6_1844 = (now + timedelta(minutes=6)).strftime("%Y-%m-%d 18:44:00")
    d6_2209 = (now + timedelta(minutes=6)).strftime("%Y-%m-%d 22:09:00")
