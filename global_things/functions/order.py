...
def amount_to_be_paid(subscription_information: tuple, discount_information: tuple):
    ...
    subscription_title = subscription_information[0][1]
    subscription_original_price = subscription_information[0][2]
    subscription_price = subscription_information[0][3]
    subscription_period_days = subscription_information[0][4]
